...
#    return (shortNM, openPrice, prevClosePrice, lastPrice, highPrice, lowPrice,
#            volume, value, bidBook_volume1, bidBook_price1, askBook_volume1,
#            askBook_price1, dataDate, dataTime, average)
